...
def main_menu(frames, main_menu_screen):
    ...
    cv_menu.create_text(
        c_width / 2 + 4,
        104,
        text="Welcome to Zarfen the Loot Goblin's Diablo II challenge dashboard",
    ...
    cv_menu.create_text(
        c_width / 2 + 4,
        134,
        text="This project was made mainly for Zarfen for his challenges, but",
    ...
    cv_menu.create_text(
        c_width / 2 + 4,
        159,
        text="secondly for the entire Diablo II community to enjoy it",
        font=("Georgia", 14, "bold"),
        fill="black",
    )
    cv_menu.create_text(
    ...
    cv_menu.create_text(
        489,
        378,
        text="As time goes by, the project will have more and more challenges. \nCurrent challenges: \n\t- Random build: Create a character and embrace the chaos! Every level-up assigns \n\t\t         random skills and stats, forcing you to adapt your playstyle on the fly.",
        font=("Georgia", 14, "bold"),
        fill="black",
    )
    cv_menu.create_text(
...
def add_one_skill(
    ...
    try:
        ...
        if lvlup == True:
            ...
            relocate_level_indicators(
                character, skill_tree_canvases, skill_positions, skill_level_texts, skill_level_rectangles
            )
            save_character(character)
    except IndexError as e:
        level_up_canvas.itemconfig(
            next_texts[10], text=f"   No skills are\n      available.\nLevel up before\n   trying again."
        )
        level_up_canvas.itemconfig(
            next_texts[11], text=f"   No skills are\n      available.\nLevel up before\n   trying again."
        )
...
def show_ch1_character_creation_screen(frames, screen):
    ...
    class_combobox.bind(
        "<<ComboboxSelected>>", lambda event, c=class_combobox, i=image_label,: on_class_combobox_change(c, i)
    )
    ...
    cv.create_text(
        473,
        403,
        text="If you want an absolutely random\nexperience,let the class to be\nrandomized as well",
    ...
    checkbox = tk.Checkbutton(
        screen,
        text="Randomize class",
        font=("Georgia", 16, "bold"),
        variable=checkbox_var,
        command=lambda: on_class_checkbox_change(checkbox_var, class_combobox, cv, is_randomized_text),
        cursor="hand2",
        bg="#222222",
        fg="#b0b0b0",
    )
    ...
    create_character_button = tk.Button(
        screen,
        image=button_photo,
        compound="center",
        fg="#cfc8b8",
        ...
        font=("Georgia", 14, "bold"),
        borderwidth=0,
        highlightcolor="#100605",
        highlightbackground="#100605",
        cursor="hand2",
        command=lambda: create_new_character(
            class_combobox.get(), checkbox_var.get(), create_character_entry, cv, error_text
        ),
    )
    ...
    cv.create_text(
        353,
        703,
        text="You can load a character that was already created \nbefore in the app. Choose the JSON file that \nrepresents the character you want to upload",
        font=("Georgia", 16, "bold"),
        fill="black",
    )
    cv.create_text(
    ...
    load_character_button = tk.Button(
        screen,
        image=button_photo,
        compound="center",
        fg="#cfc8b8",
...
def show_ch1_main_screen(frames, top_subframe, bottom_subframe, character):
    ...
    merged_label = tk.Label(
        top_subframe,
        text=f"Your current {character.__class__.__name__} skill tree",
        bg="black",
        fg="#b0b0b0",
        font=("Georgia", 18, "bold"),
    )
    ...
    layouts = [character.skill_trees[0].layout, character.skill_trees[1].layout, character.skill_trees[2].layout]
    ...
    for col in range(3):
        ...
        canvas.create_text(
            canvas_width // 2 + 3,
            y_offset - 40 + 3,
            text=character.skill_trees[col].name,
    ...
    new_char_btn = tk.Button(
        ...
        highlightbackground="#100605",
        relief="sunken",
        command=lambda: show_ch1_character_creation_screen(content_frames, ch1_character_creation_screen),
    )
    ...
    import_char_btn = tk.Button(
        bottom_subframe,
        text="Load character",
        image=import_char_photo,
        font=("Georgia", 10, "bold"),
        compound="center",
        fg="#cfc8b8",
        bg="#100605",
    ...
    offset = 60
    # Current level
    player_name_text_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        3 + 25,
        text=f"{character.username}",
        font=("Georgia", 12, "bold"),
        fill="black",
    )
    player_name_text_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2, 25, text=f"{character.username}", font=("Georgia", 12, "bold"), fill="#ded1ab"
    )
    # Current level
    current_level_text_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        3 + 55,
    ...
    current_level_text_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2,
        55,
        text=f"Level {character.level}",
        font=("Georgia", 14, "bold"),
        fill="#918e89",
    ...
    # Current stats
    current_stats_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        15 + 3 + offset,
        text="Current stats",
        font=("Georgia", 14, "bold"),
    ...
    current_stats_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2, 15 + offset, text="Current stats", font=("Georgia", 14, "bold"), fill="#918e89"
    )
    current_texts.append(current_stats_1)
    current_texts.append(current_stats_2)
    # Strength
    current_strength_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        35 + 3 + offset,
        text=f"{character.strength} strength",
        font=("Georgia", 12, "bold"),
        fill="black",
    )
    current_strength_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2,
        35 + offset,
        text=f"{character.strength} strength",
        font=("Georgia", 12, "bold"),
    ...
    # Dexterity
    current_dexterity_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        55 + 3 + offset,
        text=f"{character.dexterity} dexterity",
        font=("Georgia", 12, "bold"),
        fill="black",
    )
    current_dexterity_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2,
        55 + offset,
        text=f"{character.dexterity} dexterity",
        font=("Georgia", 12, "bold"),
    ...
    # Vitality
    current_vitality_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        75 + 3 + offset,
        text=f"{character.vitality} vitality",
        font=("Georgia", 12, "bold"),
        fill="black",
    )
    current_vitality_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2,
        75 + offset,
        text=f"{character.vitality} vitality",
        font=("Georgia", 12, "bold"),
    ...
    # Energy
    current_energy_1 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2 + 3,
        95 + 3 + offset,
        text=f"{character.energy} energy",
        font=("Georgia", 12, "bold"),
        fill="black",
    )
    current_energy_2 = current_stats_canvas.create_text(
        current_stats_canvas_width / 2,
        95 + offset,
        text=f"{character.energy} energy",
        font=("Georgia", 12, "bold"),
    ...
    # Lv. X stats
    offset = 19
    next_level_1 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 15 + 3 + offset, text="", font=("Georgia", 14, "bold"), fill="black"
    )
    next_level_2 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 15 + offset, text="", font=("Georgia", 14, "bold"), fill="#918e89"
    )
    next_texts.append(next_level_1)
    next_texts.append(next_level_2)
    # Strength
    next_stats_1 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 35 + 3 + offset, text="", font=("Georgia", 12, "bold"), fill="black"
    )
    next_stats_2 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 35 + offset, text="", font=("Georgia", 12, "bold"), fill="#b0b0b0"
    )
    next_texts.append(next_stats_1)
    next_texts.append(next_stats_2)
    # Dexterity
    next_stats_3 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 55 + 3 + offset, text="", font=("Georgia", 12, "bold"), fill="black"
    )
    next_stats_4 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 55 + offset, text="", font=("Georgia", 12, "bold"), fill="#b0b0b0"
    )
    next_texts.append(next_stats_3)
    next_texts.append(next_stats_4)
    # Vitality
    next_stats_5 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 75 + 3 + offset, text="", font=("Georgia", 12, "bold"), fill="black"
    )
    next_stats_6 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 75 + offset, text="", font=("Georgia", 12, "bold"), fill="#b0b0b0"
    )
    next_texts.append(next_stats_5)
    next_texts.append(next_stats_6)
    # Energy
    next_stats_7 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 95 + 3 + offset, text="", font=("Georgia", 12, "bold"), fill="black"
    )
    next_stats_8 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 95 + offset, text="", font=("Georgia", 12, "bold"), fill="#b0b0b0"
    )
    next_texts.append(next_stats_7)
    next_texts.append(next_stats_8)
    # Lv. X skill
    next_level_3 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 135 + 3 + offset, text="", font=("Georgia", 14, "bold"), fill="black"
    )
    next_level_4 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 135 + offset, text="", font=("Georgia", 14, "bold"), fill="#918e89"
    )
    next_texts.append(next_level_3)
    next_texts.append(next_level_4)
    # Skill name
    next_skill_1 = level_up_canvas.create_text(
        level_up_canvas_width / 2 + 3, 155 + 3 + offset, text="", font=("Georgia", 12, "bold"), fill="black"
    )
    next_skill_2 = level_up_canvas.create_text(
        level_up_canvas_width / 2, 155 + offset, text="", font=("Georgia", 12, "bold"), fill="#b0b0b0"
    )
...
title_label = tk.Label(
    header_frame, text="Zarfen Diablo II Challenges", font=("Georgia", 22, "bold"), height=2, bg="#100605", fg="#ffb955"
)
title_label.pack()
